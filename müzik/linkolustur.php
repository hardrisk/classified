...
$az = ($_POST["name"]);
$asd = ($_POST["email"]);
$whois = "https://www.whois.com/whois/"; //çöp
$trwhois = "http://www.whois.com.tr/domain/"; //çöp
$isup = "http://isup.me/"; //çöp
$vimeo = "https://player.vimeo.com/video/"; //çöp
...
textarea{font-size:80%;text-align:center;width:700px;height:100px;outline:none;border:2px solid black;z-index:1}
</style>
<center><br><br>
