...
echo "<strong id='entari$entarinosu' class='entarinosustrong'>$entarinosu</strong>.)<br>";
echo "<center><div class='entaridivi'>";
echo "<label>" .nl2br($entarimetni). "</label><br>";
echo "<span class='yazanspan'>$yazan</span><br>";
echo "<span class='tarihspan'>$saatvetarih</span></div><p></center>";
}
?>
...
<style>
label{position:relative;top:8px;font-size:16px}
.entaridivi{margin-top:8px;border:2px solid #232323;background-color:darkgray;color:black;width:98%}
.yazanspan{font-size:14px;color:red;margin-left:87%}
.tarihspan{font-size:12px;color:darkblue;margin-left:87%}
.entarinosustrong{margin-left:10px;margin-top:30px}
</style>
